...
public:
    ...
    friend Vec3f operator/(const float f, const Vec3f &v) {
...
public:
    ...
    void apply(int (*func)(int in)) {
        Set(func(x()), func(y()), func(z()));
    }
