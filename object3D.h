...
#ifndef ASSIGNMENT_5_OBJECT3D_H
#define ASSIGNMENT_5_OBJECT3D_H
...
public:
    ...
    // ====================================================================
    // GLfloat *glMatrix = matrix.glGet(); glMultMatrixf(glMatrix); delete[] glMatrix;
    // ====================================================================
